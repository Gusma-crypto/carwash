    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
                <a href="<?= base_url('admin/trasaksi/booking') ?>" class="nav-link">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= base_url('admin/loket') ?>" class="nav-link">
                  <i class="fas fa-table nav-icon"></i>
                  <p>Loket</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url('admin/jenislayanan') ?>" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= base_url('admin/services/pendaftaran') ?>" class="nav-link">
              ...
              <li class="nav-item">
                <a href="<?= base_url('admin/services/invoice') ?>" class="nav-link">
